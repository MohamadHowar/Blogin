...
<head>
  ...
  <title>Blogin Administrator</title>
</head>
<body>
<nav class="navbar navbar-toggleable-sm navbar-inverse bg-inverse p-0">
  <div class="container">
    <button class="navbar-toggler navbar-toggler-right" data-toggle="collapse" data-target="#navbarNav">
      ...
      <a href="index.html" class="navbar-brand mr-3">Blogin</a>
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
          <li class="nav-item px-2"><a href="index.html" class="nav-link ">Dashboard</a></li>
          <li class="nav-item px-2"><a href="posts.html" class="nav-link active">Posts</a></li>
        ...
        <!--ml-auto will push it to right side-->
        <ul class="navbar-nav ml-auto">
        <li class="nav-item dropdown mr-3">
          <a href="" class="nav-link dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i>
            Welcome Mohamed</a>
            <div class="dropdown-menu">
              <a href="setting.html" class="dropdown-item"><i class="fa fa-user-circle"></i> Profile</a>
...
<footer id="main-footer" class="bg-inverse text-white mt-5 p-5">
  <div class="container">
    <div class="row">
      <div class="col">
        <p class="lead text-center">Copyright &copy; 2017 Mohamed Ismail</p>
      </div>
    </div>
  </div>
</footer>
